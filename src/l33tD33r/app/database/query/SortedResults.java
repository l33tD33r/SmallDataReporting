...
public class SortedResults {
	...
	private ArrayList<Row> sortedRows;
	...
	public SortedResults(Query query) {
		...
		this.sortedRows = new ArrayList<Row>();
	}
	
	protected void addRow(Row newRow) {
		int newRowIndex = -1;
	...
	private int compareRow(Row a, Row b) {
	...
	protected ArrayList<Row> getSortedRows() {
		return sortedRows;
	}
}
